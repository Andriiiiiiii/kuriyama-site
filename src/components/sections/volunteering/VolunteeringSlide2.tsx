...
import imgRight from '@/assets/volonteering/img right 2.webp';
import imgLeft from '@/assets/volonteering/img left 2.webp';
import imgCenter from '@/assets/volonteering/img center 2.webp';
