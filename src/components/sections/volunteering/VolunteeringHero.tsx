...
import heroBg from '@/assets/1-background.webp'; // Assuming same background as others or generic
import imgRight from '@/assets/volonteering/img right 1.webp';
import imgCenter from '@/assets/volonteering/img center 1.webp';
