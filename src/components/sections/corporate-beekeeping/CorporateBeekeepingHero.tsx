...
import smallRightImage from '@/assets/corporate-beekeeping/up1.webp';
import largeRightImage from '@/assets/corporate-beekeeping/1-large-right.webp';
import backgroundImage from '@/assets/corporate-beekeeping/back 1.webp';
