...
import backOne from '@/assets/pollination/first_slide_back.webp';
import rightImage from '@/assets/pollination/first_slide_right_image.webp';
import leftImages from '@/assets/pollination/first_slide_left_images.webp';
...
const PolinationHero: React.FC<PolinationHeroProps> = ({ step, setStep, onInView }) => {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-layout overflow-hidden text-white isolate paint-boundary">
