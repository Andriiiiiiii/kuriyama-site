...
import img1 from '@/assets/pollination/third_slide_image_1.webp';
import img2 from '@/assets/pollination/third_slide_image_2.webp';
import img3 from '@/assets/pollination/third_slide_image_3.webp';
import img4 from '@/assets/pollination/third_slide_image_4.webp';
...
const PolinationSlide3: React.FC<PolinationSlide3Props> = ({ step, setStep, prevFinished = true, onInView }) => {
   // 1. Настройка ссылок
    ...
    const pBottom: Point    = { x: '91.6%', y: '98%' };
    const pBottomLeft: Point    = { x: '0%', y: '98%' };
  const sectors = [
    {
  ...
  return (
    <section ref={sectionRef} className="relative w-full flex bg-white min-h-layout-height items-stretch isolate paint-boundary">
      {/* Sticky Left Title */}
