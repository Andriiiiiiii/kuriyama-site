...
import leftImages from '@/assets/pollination/second_slide_left_lower_corner_images.webp';
import rightImages from '@/assets/pollination/second_slide_right_upper_corner_images.webp';
...
const PolinationSlide2: React.FC<PolinationSlide2Props> = ({ step, setStep, prevFinished = true, onInView }) => {
  ...
  return (
    <section ref={sectionRef} className="relative h-layout z-20 bg-white overflow-visible isolate">
