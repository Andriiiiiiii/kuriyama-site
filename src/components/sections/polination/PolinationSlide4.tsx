...
import centerImg from '@/assets/pollination/fourth_slide_center_images.webp';
...
const PolinationSlide4: React.FC<PolinationSlide4Props> = ({ step, setStep, prevFinished = true, onInView }) => {
  ...
  return (
    <section ref={sectionRef} className="relative w-full overflow-hidden bg-white isolate paint-boundary" style={{ height: '56.77vw' }}>
        {/* Outer Frame */}
        <div 
