...
import rightImg from '@/assets/pollination/six_slide_right_image.webp';
...
const isInView = useInView(sectionRef, { once: true, amount: 0.5 }); 
    ...
    const pCenter: Point   = { x: 'var(--five-center-x)', y: '50%' };
  ...
  return (
    <section
      ...
      style={{ height: "calc(var(--layout-height-ratio, 50vw) * 1.75)" }}
    >
      {/* Title */}
      <h2
