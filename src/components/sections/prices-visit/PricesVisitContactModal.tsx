...
import bgDayImage from "@/assets/prices-visit/bg-day.png";
...
const mf = (value: number): string =>
  `calc(${value} / ${BASE_WIDTH} * var(--prices-visit-contact-modal-width))`;
...
interface PricesVisitContactModalProps {
  open: boolean;
  onClose: () => void;
}
...
const PricesVisitContactModal: React.FC<PricesVisitContactModalProps> = ({
  open,
  onClose,
}) => {
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          "--prices-visit-contact-modal-width": MODAL_WIDTH_EXPR,
          width: "var(--prices-visit-contact-modal-width)",
          aspectRatio: "900 / 830",
...
export default PricesVisitContactModal;
