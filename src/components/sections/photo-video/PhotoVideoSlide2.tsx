...
// Images 2-1 to 2-12
import img1 from '@/assets/photo-video/2-1.webp';
import img2 from '@/assets/photo-video/2-2.webp';
import img3 from '@/assets/photo-video/2-3.webp';
import img4 from '@/assets/photo-video/2-4.webp';
import img5 from '@/assets/photo-video/2-5.webp';
import img6 from '@/assets/photo-video/2-6.webp';
import img7 from '@/assets/photo-video/2-7.webp';
import img8 from '@/assets/photo-video/2-8.webp';
import img9 from '@/assets/photo-video/2-9.webp';
import img10 from '@/assets/photo-video/2-10.webp';
import img11 from '@/assets/photo-video/2-11.webp';
import img12 from '@/assets/photo-video/2-12.webp';
    ...
    return (
        <section className="relative w-full h-screen bg-white overflow-hidden flex flex-col justify-center">
            ...
            <div className="w-full relative h-[30%]">
                 ...
                 <h2 
                    className="absolute uppercase text-[#C65A32]"
                    style={{
                        left: '8.6%',
                        top: '10%',
