...
import backgroundImage from '@/assets/beekeeping/BeekeepingHeroBackground.webp';
import beekeeperImage from '@/assets/beekeeping/1-image-beekeeper.webp';
...
const BeekeepingHero: React.FC = () => {
  return (
    <section className="relative w-full h-layout overflow-hidden">
      ...
      >
        Две строчки дополнительного описания<br/>
        подкрепляющего заголовок
      </p>
    </section>
  );
};
