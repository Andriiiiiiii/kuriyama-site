...
// Assets
import bgImage from '@/assets/beekeeping/6_background.webp';
import yellowHoney from '@/assets/beekeeping/yellow_honey.webp';
import brownHoney from '@/assets/beekeeping/brown_honey.webp';
import whiteHoney from '@/assets/beekeeping/white_honey.webp';
import blackHoney from '@/assets/beekeeping/black_honey.webp';
      ...
      <div className="sticky top-0 w-full h-layout overflow-hidden">
          ...
          >
            <button
              ...
              className="w-full h-full transform scale-125 origin-center cursor-pointer"
            >
              <ContactButton text="Перейти в каталог >" className="!w-full !h-full !text-base pointer-events-none" />
            </button>
          </motion.div>
      </div>
    </section>
