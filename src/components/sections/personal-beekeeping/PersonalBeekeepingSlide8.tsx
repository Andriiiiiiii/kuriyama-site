...
const PersonalBeekeepingSlide8: React.FC = () => {
    ...
    // Helper to convert Figma px to vw
    ...
    const cards = [
        ...
        },
        {
            ...
            title: "Отчеты",
            desc: "Описание, подробнее раскрывающее заголовок",
            // RRectangle 225: x: 40230, y: 6796, w: 490, h: 225
                ...
                {cards.map((card, i) => (
                    ...
                    >
                        ...
                        <div 
                            ...
                            style={{
                                left: toVw(card.rectPos.x),
                                top: toVw(card.rectPos.y),
                                width: toVw(card.rectPos.w),
                                height: toVw(card.rectPos.h),
                            }}
                        />
                        ...
                        <div
                            ...
                            style={{
                                left: toVw(card.numPos.x),
                                top: toVw(card.numPos.y),
                        ...
                        <h3 
                            className="absolute font-ua-brand font-bold text-[#2E261D]"
                            style={{
                                left: toVw(card.titlePos.x),
                                top: toVw(card.titlePos.y),
                        ...
                        <p 
                            className="absolute font-glametrix text-[#2E261D]"
                            style={{
                                left: toVw(card.descPos.x),
                                top: toVw(card.descPos.y),
                                width: toVw(343.8),
                                fontSize: FONT_SIZES.body,
                                lineHeight: 1.2
                            }}
