...
import imgCentral from '@/assets/concept/slide4/image 115.webp'; // Abstract strokes
import imgBee from '@/assets/concept/slide4/insect-background-closeup-pollination-beauty 1.webp'; // Bee photo
